...
export { default as AutoRefreshControl } from './components/AutoRefreshControl.vue';
...
export { applyThemePreference, toggleThemePreference } from './theme/themePreference';
